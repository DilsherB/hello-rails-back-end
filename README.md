...
The Hello Rails Backend App is a web application just to get comfortable with rails and react as one application. Here is <a href=https://github.com/DilsherB/hello-react-front-end.git>front end</a> for this app
